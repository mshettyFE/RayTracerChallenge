...
Cube::Cube(Matrix Transformation, Material material, Shape* parent) : Shape(Transformation, material, parent, "Cube"){}
...
Tuple Cube::local_normal_at(const Tuple& pt, const Impact& impt) const{
    if(pt.get_dim() != 3){
